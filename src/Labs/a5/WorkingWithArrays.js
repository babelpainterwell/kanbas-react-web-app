...
function WorkingWithArrays() {
  ...
  const updateTodo = async () => {
    try {
      ...
      //   setTodo({}); // we shouldn't set it to be an empty object, but rather a new object with default values
    } catch (error) {
      console.log(error);
      setErrorMessage(error.response.data.message);
    }
  ...
  return (
    <div>
      ...
      <a
        ...
        className="btn btn-primary me-2"
      >
        Update Complete Status to {todo.completed.toString()}
      </a>
      <a
      ...
      <a href={`${API}/todos?completed=true`} className="btn btn-primary me-2">
        Get Completed Todos
      </a>
